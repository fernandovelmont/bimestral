...
public class BimestralApplicationTests {
	...
	public void contextLoads() {
        ...
        public void ProbarInsertDireccion()throws Exception{
            ...
            Direccion dir=repoDireccion.save(new Direccion(777, "calle 13",44130L, "Ecatepec"));
        ...
        //@Test
        public void ProbarBuscarPorTodos()throws Exception{
        ...
        public void actualizar()throws Exception{
            Direccion dir=
                    repoDireccion.save(new Direccion(2L,12,"Calle del infierno",7777L,"Ecatepec"));
            assertEquals("Ecatepec",dir.getMunicipio());
        }
             @Test
